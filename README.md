# @devtea2027/quae-nulla-fuga-assumenda

[![Greenkeeper badge](https://badges.greenkeeper.io/midknight41/@devtea2027/quae-nulla-fuga-assumenda.svg)](https://greenkeeper.io/)
[![Coverage Status](https://coveralls.io/repos/github/midknight41/@devtea2027/quae-nulla-fuga-assumenda/badge.svg?branch=master)](https://coveralls.io/github/midknight41/@devtea2027/quae-nulla-fuga-assumenda?branch=master) 

[![NPM](https://nodei.co/npm/@devtea2027/quae-nulla-fuga-assumenda.png?downloads=true)](https://www.npmjs.com/package/@devtea2027/quae-nulla-fuga-assumenda/)

A simple object mapping utility that makes it easy to map data from one object to another. **@devtea2027/quae-nulla-fuga-assumenda** provides a fluent interface and supports deep references, custom transformations, and object merging.
...
```
npm install @devtea2027/quae-nulla-fuga-assumenda -S
```

## Getting Started

**@devtea2027/quae-nulla-fuga-assumenda** supports two similar interfaces. Which you use is up to you and your use case. There is no functional difference.

The basic syntax is:

```js
const createMapper = require("@devtea2027/quae-nulla-fuga-assumenda");
...
Below are some examples of the syntax used to get and set data with *@devtea2027/quae-nulla-fuga-assumenda*. More details examples can be found in the [examples](#examples) section.
...
By default, **@devtea2027/quae-nulla-fuga-assumenda** will: 
...
The core functions that power **@devtea2027/quae-nulla-fuga-assumenda** can be used directly if required.

```js
const { getValue, setValue } = require("@devtea2027/quae-nulla-fuga-assumenda");
...
**@devtea2027/quae-nulla-fuga-assumenda** supports deep object references for both source and target fields via dot notation. Mapping is explicit so unmapped fields are discarded.
...
When working with arrays of arrays, **@devtea2027/quae-nulla-fuga-assumenda** tries to figure out what array shape is appropriate and will automatically flatten arrays when appropriate.
...
**@devtea2027/quae-nulla-fuga-assumenda** also provides the ```each()``` method to help work with arrays and multiple mappers. This is useful when child objects within your main object have the same structure.
...
If you are using using Promises with **@devtea2027/quae-nulla-fuga-assumenda** you can use ```executeAsync``` which returns a promise.
...
If, however, you are trying to pick from one source or another source field, **@devtea2027/quae-nulla-fuga-assumenda** provides a bit of syntax sugar to make things a bit easier. Transformations are supported with this method too.
